...
// void insertionMode(GLFWwindow* window, int button, int action, int mods, Eigen::MatrixXf* V,int* counter,VertexArrayObject* VBO);
// void translationMode(GLFWwindow* window, int button, int action, int mods, Eigen::MatrixXf* V,int* counter,VertexArrayObject* VBO);
// void deleteMode(GLFWwindow* window, int button, int action, int mods, Eigen::MatrixXf* V,int* counter,VertexArrayObject* VBO);
